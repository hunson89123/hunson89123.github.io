...
const show_length = 5;
const light_rnd_color = "rgb(" + (Math.floor(Math.random() * 55) + 200) + "," + (Math.floor(Math.random() * 55) + 150) + ",0)";
const dark_rnd_color = "rgb(" + (Math.floor(Math.random() * 200)) + "," + (Math.floor(Math.random() * 125)) + ",0)";
var food_iter = 0;
